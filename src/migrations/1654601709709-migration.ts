...
export class migration1654601709709 implements MigrationInterface {
    name = 'migration1654601709709'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`subastas\` ADD \`preciosubasta\` float NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`subastas\` DROP COLUMN \`preciosubasta\``);
    }
