...
export class migration1654355617002 implements MigrationInterface {
    name = 'migration1654355617002'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`subastas-destacadas\` (\`iddestacada\` int NOT NULL AUTO_INCREMENT, \`subastaid\` int NOT NULL, PRIMARY KEY (\`iddestacada\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`subastas-destacadas\` ADD CONSTRAINT \`FK_42d754ace20fbb4c18cdc386910\` FOREIGN KEY (\`subastaid\`) REFERENCES \`subastas\`(\`idsubasta\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`subastas-destacadas\` DROP FOREIGN KEY \`FK_42d754ace20fbb4c18cdc386910\``);
        await queryRunner.query(`ALTER TABLE \`subastas\` DROP FOREIGN KEY \`FK_e1f12efabb0283c5ca2dd424e04\``);
        await queryRunner.query(`ALTER TABLE \`subastas\` DROP FOREIGN KEY \`FK_f68ffbab81564bf6886882f9213\``);
        ...
        await queryRunner.query(`DROP TABLE \`subastas-destacadas\``);
    }
