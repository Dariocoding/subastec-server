...
export class migration1654731859202 implements MigrationInterface {
    name = 'migration1654731859202'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`productos\` ADD \`descripcion\` text NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`productos\` DROP COLUMN \`descripcion\``);
        await queryRunner.query(`ALTER TABLE \`productos\` ADD \`descripcion\` varchar(255) NOT NULL`);
