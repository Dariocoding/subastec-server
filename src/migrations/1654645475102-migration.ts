...
export class migration1654645475102 implements MigrationInterface {
    name = 'migration1654645475102'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pujas\` ADD \`costopuja\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`pujas\` ADD \`date_created\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pujas\` DROP COLUMN \`date_created\``);
        await queryRunner.query(`ALTER TABLE \`pujas\` DROP COLUMN \`costopuja\``);
    }
