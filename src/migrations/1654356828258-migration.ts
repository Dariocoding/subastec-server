...
export class migration1654356828258 implements MigrationInterface {
    name = 'migration1654356828258'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`subastas-destacadas\` CHANGE \`iddestacada\` \`iddestacado\` int NOT NULL AUTO_INCREMENT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`subastas-destacadas\` CHANGE \`iddestacado\` \`iddestacada\` int NOT NULL AUTO_INCREMENT`);
    }
