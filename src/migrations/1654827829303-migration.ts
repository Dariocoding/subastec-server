...
export class migration1654827829303 implements MigrationInterface {
    name = 'migration1654827829303'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`pujas\` ADD \`modalidad\` varchar(50) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pujas\` DROP COLUMN \`modalidad\``);
    }
