...
export class migrations1655847342527 implements MigrationInterface {
    name = 'migrations1655847342527'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`pujas\` ADD \`idpuja\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
