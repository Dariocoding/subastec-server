...
export class migrations1656629395789 implements MigrationInterface {
    name = 'migrations1656629395789'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`categorias\` CHANGE \`portada\` \`portada\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`categorias\` CHANGE \`portada\` \`portada\` varchar(255) NOT NULL`);
