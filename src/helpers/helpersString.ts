...
export const hexTestMongoObjId = (data: string) =>
	mongo.ObjectId.isValid(data) ? new mongo.ObjectId(data) : '';
...
export const crearURLAmigable = slug => {
...
export const controlDecimal = string =>
	string
		.replace(/\D/g, '')
